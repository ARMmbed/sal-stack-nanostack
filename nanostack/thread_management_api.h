 ...
 * \param cb_ptr A callback function to indicate the result of the operation. Can be NULL if no result code needed.
 *
 * \return 0, Success.
 * \return <0 Fail.
 */
 ...
 * \param response_message_len Length of the message.
 *
 * \return 0, Success.
 * \return <0 Fail.
 */
